...
<button onClick={()=>setCaDiscardStep(1)} style={{flex:"0 0 auto",padding:"10px 16px",border:"2px solid rgba(231,76,60,0.4)",borderRadius:10,background:"rgba(231,76,60,0.1)",color:"var(--danger)",fontSize:14,fontWeight:700,cursor:"pointer"}}>{"🗑"} 破棄</button>
</div></div>}
...
<button onClick={()=>{setDraftRestored(true);if(onClearSetupDraft)onClearSetupDraft();}} style={{flex:"0 0 auto",padding:"12px 16px",border:"2px solid rgba(231,76,60,0.4)",borderRadius:10,background:"rgba(231,76,60,0.1)",color:"var(--danger)",fontSize:14,fontWeight:700,cursor:"pointer"}}>{"🗑"} 破棄する</button>
</div></div>}
